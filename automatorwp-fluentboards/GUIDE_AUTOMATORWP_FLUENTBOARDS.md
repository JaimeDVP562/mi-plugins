...
- [✅] Se crea un nuevo contacto en Mail Mint *(soportado: función PHP pública)*
- [❌] Un contacto de Mail Mint se suscribe *(no soportado: no hay hook/evento)*
- [❌] Un contacto de Mail Mint se desuscribe *(no soportado: no hay hook/evento)*
- [❌] Un contacto confirma el doble opt-in *(no soportado: no hay hook/evento)*
- [✅] Se aplica una etiqueta a un contacto *(soportado: función PHP pública)*
- [✅] Se elimina una etiqueta de un contacto *(soportado: función PHP pública)*
- [✅] Se añade un contacto a una lista *(soportado: función PHP pública)*
- [✅] Se elimina un contacto de una lista *(soportado: función PHP pública)*
- [❌] Un formulario de Mail Mint es enviado *(no soportado: no hay hook/evento)*
- [❌] Un contacto abre un email *(no soportado: no hay hook/evento)*
- [❌] Un contacto hace clic en un email *(no soportado: no hay hook/evento)*

### Actions (Acciones)
- [✅] Crear o actualizar un contacto *(soportado: función PHP pública)*
- [✅] Cambiar el estado de un contacto *(soportado: función PHP pública, campo status)*
- [❌] Enviar email de doble opt-in *(no soportado: no hay función/hook público)*
- [✅] Añadir etiqueta a un contacto *(soportado: función PHP pública)*
- [✅] Eliminar etiqueta de un contacto *(soportado: función PHP pública)*
- [✅] Añadir contacto a una lista *(soportado: función PHP pública)*
- [✅] Eliminar contacto de una lista *(soportado: función PHP pública)*