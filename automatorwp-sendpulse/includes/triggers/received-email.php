...
class AutomatorWP_SendPulse_Received_Email_Trigger extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'action'        => 'automatorwp_sendpulse_received_email',
            'function'      => array( $this, 'listener' ),
            'priority'      => 10,
            'accepted_args' => 2, // email, subject
            ...
            'tags'          => array_merge( array(
                ...
                'sendpulse_subject' => array( 'label' => __( 'Email Subject', 'automatorwp-sendpulse' ), 'type' => 'text', 'preview' => __( 'The subject of the received email', 'automatorwp-sendpulse' ) ),
