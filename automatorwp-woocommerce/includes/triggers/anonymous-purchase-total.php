<?php
/**
 * Anonymous Purchase Total
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Purchase_Total
...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Total extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_purchase_total';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest completes a purchase with a total greater than, less than or equal to a specific amount', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest completes a purchase with a total <strong>greater than, less than or equal</strong> to a specific amount', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Condition. %2$s: Amount. %3$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest completes a purchase with a total %1$s %2$s %3$s time(s)', 'automatorwp-woocommerce' ), '{condition}', '{amount}', '{times}' ),
            /* translators: %1$s: Condition. %2$s: Amount. */
            'log_label'         => sprintf( __( 'Guest completes a purchase with a total %1$s %2$s', 'automatorwp-woocommerce' ), '{condition}', '{amount}' ),
...
new AutomatorWP_WooCommerce_Anonymous_Purchase_Total();