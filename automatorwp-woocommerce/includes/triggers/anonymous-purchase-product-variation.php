<?php
/**
 * Anonymous Purchase Product Variation
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Purchase_Product_Variation
...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Variation extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_purchase_product_variation';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest purchases a product variation', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest purchases a product <strong>variation</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Product. %2$s: Variation. %3$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest purchases %1$s with %2$s selected %3$s time(s)', 'automatorwp-woocommerce' ), '{product}', '{variation}', '{times}' ),
            /* translators: %1$s: Product. %2$s: Variation. */
            'log_label'         => sprintf( __( 'Guest purchases %1$s with %2$s selected', 'automatorwp-woocommerce' ), '{product}', '{variation}' ),
...
new AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Variation();