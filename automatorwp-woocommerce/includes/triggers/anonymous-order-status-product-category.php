<?php
/**
 * Anonymous Order Status Product Category
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Order_Status_Porduct_Category
...
class AutomatorWP_WooCommerce_Anonymous_Order_Status_Porduct_Category extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_order_status_product_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest\'s order with a product of a category changes its status', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest\'s order with a product of <strong>a category</strong> changes its <strong>status</strong>', 'automatorwp-woocommerce' ),
...
new AutomatorWP_WooCommerce_Anonymous_Order_Status_Porduct_Category();