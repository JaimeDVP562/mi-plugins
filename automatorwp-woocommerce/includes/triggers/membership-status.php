 ...
 * Membership Status
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Membership_Status
...
class AutomatorWP_WooCommerce_Membership_Status extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_membership_status';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User\'s access to membership changes to a status', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User\'s access to <strong>membership</strong> changes to a status', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Status. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User\'s access to %1$s changes to %2$s status %3$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{status}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User\'s access to %1$s changes to %2$s status', 'automatorwp-woocommerce' ), '{post}', '{status}' ),
                    ...
                    'fields' => array(
                        'status' => array(
                            ...
                            'options' => array(
                                ...
                                'delayed'       => __( 'Delayed', 'automatorwp-woocommerce' ),
                                'complimentary' => __( 'Complimentary', 'automatorwp-woocommerce' ),
                                'pending'       => __( 'Pending Cancellation', 'automatorwp-woocommerce' ),
                                'paused'        => __( 'Paused', 'automatorwp-woocommerce' ),
    ...
    public function listener( $membership_plan, $old_status, $new_status ) {
        ...
        // Bail if membership gets same status
...
new AutomatorWP_WooCommerce_Membership_Status();