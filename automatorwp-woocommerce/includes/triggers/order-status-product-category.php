 ...
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Order_Status_Product_Category
...
class AutomatorWP_WooCommerce_Order_Status_Product_Category extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_order_status_product_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User\'s order with a product of a category changes its status', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User\'s order with a product of <strong>a category</strong> changes its <strong>status</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Term title. %2$s: Order status. %3$s: Number of times. */
            'edit_label'        => sprintf( __( 'User\'s order with a product of %1$s changes its status to %2$s %3$s time(s)', 'automatorwp-woocommerce' ), '{term}', '{status}', '{times}' ),
            /* translators: %1$s: Term title. %2$s: Order status. */
            'log_label'         => sprintf( __( 'User\'s order with a product of %1$s changes its status to %2$s', 'automatorwp-woocommerce' ), '{term}', '{status}' ),
...
new AutomatorWP_WooCommerce_Order_Status_Product_Category();