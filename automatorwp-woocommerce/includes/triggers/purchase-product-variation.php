<?php
/**
 * Purchase Product Variation
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Purchase_Product_Variation
...
class AutomatorWP_WooCommerce_Purchase_Product_Variation extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_purchase_product_variation';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a product variation', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User purchases a product <strong>variation</strong>', 'automatorwp-woocommerce' ),
...
new AutomatorWP_WooCommerce_Purchase_Product_Variation();