 ...
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Subscription_Renewal_Category
...
class AutomatorWP_WooCommerce_Subscription_Renewal_Category extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_subscription_renewal_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User renews subscription of a category', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User renews subscription of <strong>a category</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User renews subscription of %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'User renews subscription of %1$s', 'automatorwp-woocommerce' ), '{term}' ),
...
new AutomatorWP_WooCommerce_Subscription_Renewal_Category();