<?php
/**
 * Purchase Subscription Category
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Purchase_Subscription_Category
...
class AutomatorWP_WooCommerce_Purchase_Subscription_Category extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_purchase_subscription_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases subscription of a category', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User <strong>purchases</strong> subscription of a category', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases subscription of %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'User purchases subscription of %1$s', 'automatorwp-woocommerce' ), '{term}' ),
...
new AutomatorWP_WooCommerce_Purchase_Subscription_Category();