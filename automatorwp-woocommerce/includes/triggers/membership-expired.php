 ...
 * Membership Expired
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Membership_Expired
...
class AutomatorWP_WooCommerce_Membership_Expired extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_membership_expired';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User\'s access to membership expires', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User\'s access to <strong>membership expires</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User\'s access to %1$s expires %2$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User\'s access to %1$s expires', 'automatorwp-woocommerce' ), '{post}' ),
    ...
    public function listener( $membership_plan, $old_status, $new_status ) {
        ...
        // Bail if membership has not expired
...
new AutomatorWP_WooCommerce_Membership_Expired();