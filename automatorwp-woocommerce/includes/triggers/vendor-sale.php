 ...
 * Vendor Sale
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Vendor_Sale
...
class AutomatorWP_WooCommerce_Vendor_Sale extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_vendor_sale';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'Vendor gets a sale on a product', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Vendor gets a sale on <strong>a product</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Vendor gets a sale on %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Vendor gets a sale on %1$s', 'automatorwp-woocommerce' ), '{post}' ),
    ...
    function log_meta( $log_meta, $trigger, $user_id, $event, $trigger_options, $automation ) {
        ...
        $log_meta['customer_id'] = ( isset( $event['customer_id'] ) ? $event['customer_id'] : 0 );
...
new AutomatorWP_WooCommerce_Vendor_Sale();