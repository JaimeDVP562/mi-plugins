 ...
 * Delete a List
 *
 * @package     AutomatorWP\Integrations\Selzy\Actions\List_Delete
...
class AutomatorWP_Selzy_Del_List extends AutomatorWP_Integration_Action {

    public $integration = 'selzy';
    public $action = 'selzy_del_list';
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Delete list', 'automatorwp-selzy' ),
            'select_option'     => __( 'Delete <strong>list</strong>', 'automatorwp-selzy' ),
            /* translators: %1$s: List. */
            'edit_label'        => sprintf( __( 'Delete %1$s', 'automatorwp-selzy' ), '{list}' ),
            /* translators: %1$s: List. */
            'log_label'         => sprintf( __( 'Delete %1$s', 'automatorwp-selzy' ), '{list}' ),
            'options'           => array(
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $response = automatorwp_selzy_delete_list( $list_id );

        if ( $response === 200 ) {
            $this->result = __( 'List deleted', 'automatorwp-selzy' );
        } else {
            $this->result = __( 'Couldnt delete list', 'automatorwp-selzy' );
        }
...
new AutomatorWP_Selzy_Del_List();