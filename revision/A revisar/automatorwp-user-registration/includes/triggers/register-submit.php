...
class AutomatorWP_User_Registration_User_Register extends AutomatorWP_Integration_Trigger {

    public $integration = 'user_registration';
    public $trigger = 'user_registration_user_register';
  ...
  automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User registers in a form', 'automatorwp-user-registration' ),
            'select_option'     => __( 'User <strong>registers</strong> in a form', 'automatorwp-user-registration' ),
            /* translators  %1$s: Number of times.*/
            'edit_label'        => sprintf( __( ' User registers through %1$s time(s)', 'automatorwp-user-registration' ), '{times}' ),
    ...
    public function listener( $form_data, $form_id, $user_id ) {
...
new AutomatorWP_User_Registration_User_Register();