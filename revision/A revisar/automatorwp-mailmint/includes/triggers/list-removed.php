 ...
 *
 * @package     AutomatorWP\Integrations\MailMint\Triggers\List_Removed
...
class AutomatorWP_MailMint_List_Removed extends AutomatorWP_Integration_Trigger
{
    public $integration = 'mailmint';
    public $trigger     = 'mailmint_list_removed';
    ...
    public function register()
    {
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'         => __( 'A contact is removed from a Mail Mint list', 'automatorwp-mailmint' ),
            'select_option' => __( 'A contact is removed from a Mail Mint <strong>list</strong>', 'automatorwp-mailmint' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A contact is removed from a Mail Mint list %1$s time(s)', 'automatorwp-mailmint' ), '{times}' ),
            'log_label'     => __( 'A contact is removed from a Mail Mint list', 'automatorwp-mailmint' ),
            'action'        => 'mint_list_removed',
            ...
            'tags' => array_merge(
                array(
                    ...
                    'mailmint_list_title' => array(
                        ...
                        'type'    => 'text',
                        'preview' => __( 'The list the contact was removed from', 'automatorwp-mailmint' ),
                    ),
                ),
    ...
    /**
     * Trigger listener — fires on mint_list_removed
     *
     * Hook passes: $lists (array), $contact_ids (array of int)
     *
     * @since 1.0.0
     *
     * @param array $lists
     ...
     */
    public function listener( $lists, $contact_ids )
    {
...
new AutomatorWP_MailMint_List_Removed();
