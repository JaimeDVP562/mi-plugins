 ...
 *
 * @package     AutomatorWP\Integrations\MailMint\Triggers\Contact_Unsubscribed
...
class AutomatorWP_MailMint_Contact_Unsubscribed extends AutomatorWP_Integration_Trigger
{
    public $integration = 'mailmint';
    public $trigger     = 'mailmint_contact_unsubscribed';
    ...
    public function register()
    {
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'         => __( 'A Mail Mint contact unsubscribes', 'automatorwp-mailmint' ),
            'select_option' => __( 'A Mail Mint contact <strong>unsubscribes</strong>', 'automatorwp-mailmint' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A Mail Mint contact unsubscribes %1$s time(s)', 'automatorwp-mailmint' ), '{times}' ),
            'log_label'     => __( 'A Mail Mint contact unsubscribes', 'automatorwp-mailmint' ),
            'action'        => 'mint_subscriber_status_to_unsubscribed',
    ...
    /**
     * Trigger listener — fires on mint_subscriber_status_to_unsubscribed
     *
     * @since 1.0.0
     *
...
new AutomatorWP_MailMint_Contact_Unsubscribed();
