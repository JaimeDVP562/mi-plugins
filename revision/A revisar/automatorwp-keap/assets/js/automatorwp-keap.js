(function( $ ) {
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_keap_authorize',
                nonce: automatorwp_keap.nonce,
    ...
    // On change board
    $('body').on('change', '.automatorwp-action-keap-create-card .cmb2-id-board select, '
    + '.automatorwp-action-keap-change-card-list .cmb2-id-board select, '
    + '.automatorwp-action-keap-delete-card .cmb2-id-board select, '
    + '.automatorwp-action-keap-change-desc .cmb2-id-board select, '
    + '.automatorwp-action-keap-comment-card .cmb2-id-board select, '
    + '.automatorwp-action-keap-add-label .cmb2-id-board select, '
    + '.automatorwp-action-keap-add-member .cmb2-id-board select, '
    + '.automatorwp-action-keap-add-checklist-item .cmb2-id-board select', function(e, first_change) {
    ...
    $('body').on('change', '.automatorwp-action-keap-change-card-list .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-keap-add-label .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-keap-add-member .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-keap-add-checklist-item .cmb2-id-card select', function(e, first_change) {
    ...
    // On change list
    $('body').on('change', '.automatorwp-action-keap-change-card-list .cmb2-id-list select, '
    + '.automatorwp-action-keap-delete-card .cmb2-id-list select, '
    + '.automatorwp-action-keap-change-desc .cmb2-id-list select, '
    + '.automatorwp-action-keap-comment-card .cmb2-id-list select, '
    + '.automatorwp-action-keap-add-label .cmb2-id-list select, '
    + '.automatorwp-action-keap-add-member .cmb2-id-list select, '
    + '.automatorwp-action-keap-add-checklist-item .cmb2-id-list select', function(e, first_change) {
    ...
    $('body').on('click', '.automatorwp-automation-item-label > .automatorwp-option', function(e) {
        ...
        var item = $(this).closest('.automatorwp-automation-item[class*="keap"]');
