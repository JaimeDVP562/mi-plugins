...
class AutomatorWP_Trello_Add_Label extends AutomatorWP_Integration_Action {

    public $integration = 'trello';
    public $action = 'trello_add_label';
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add a label in a card', 'automatorwp-trello'),
            'select_option'     => __( 'Add a <strong>label</strong> in a card', 'automatorwp-trello'),
            /* translators: %1$s: Card. */
            'edit_label'        => sprintf( __( 'Add a new label in %1$s', 'automatorwp-trello' ), '{card}' ),
            /* translators: %1$s: Card. */
            'log_label'         => sprintf( __( 'Add a new label in %1$s', 'automatorwp-trello' ), '{card}' ),
            'options'           => array(
                'card' => array(
                    'from' => 'card',
