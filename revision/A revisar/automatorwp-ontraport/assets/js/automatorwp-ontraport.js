(function( $ ) {
    ...
    var prefix = 'automatorwp-ontraport-';
    var _prefix = 'automatorwp_ontraport_';
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        if( app_id.length === 0 || api_key.length === 0 ) {
            ...
            response_wrap.html( 'All fields are required to connect with Ontraport' );
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_ontraport_authorize',
                nonce: automatorwp_ontraport.nonce,
                app_id: app_id,
                api_key: api_key,
            },
            function( response ) {
    ...
    // On change board
    $('body').on('change', '.automatorwp-action-ontraport-create-card .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-change-card-list .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-delete-card .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-change-desc .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-comment-card .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-add-label .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-add-member .cmb2-id-board select, '
    + '.automatorwp-action-ontraport-add-checklist-item .cmb2-id-board select', function(e, first_change) {
    ...
    $('body').on('change', '.automatorwp-action-ontraport-change-card-list .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-ontraport-add-label .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-ontraport-add-member .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-ontraport-add-checklist-item .cmb2-id-card select', function(e, first_change) {
    ...
    // On change list
    $('body').on('change', '.automatorwp-action-ontraport-change-card-list .cmb2-id-list select, '
    + '.automatorwp-action-ontraport-delete-card .cmb2-id-list select, '
    + '.automatorwp-action-ontraport-change-desc .cmb2-id-list select, '
    + '.automatorwp-action-ontraport-comment-card .cmb2-id-list select, '
    + '.automatorwp-action-ontraport-add-label .cmb2-id-list select, '
    + '.automatorwp-action-ontraport-add-member .cmb2-id-list select, '
    + '.automatorwp-action-ontraport-add-checklist-item .cmb2-id-list select', function(e, first_change) {
    ...
    $('body').on('click', '.automatorwp-automation-item-label > .automatorwp-option', function(e) {
        ...
        var item = $(this).closest('.automatorwp-automation-item[class*="ontraport"]');
