 ...
 * @since  1.1.8
 */
function gamipress_wc_points_gateway_hpos_compatibility() {
    if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
		\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', GAMIPRESS_WC_POINTS_GATEWAY_FILE, true );
	}
}
add_action( 'before_woocommerce_init', 'gamipress_wc_points_gateway_hpos_compatibility' );