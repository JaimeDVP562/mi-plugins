...
<?php do_action( 'gamipress_wc_points_gateway_checkout_before', $a ); ?>
    ...
    <div id="block-payment-method-gamipress-<?php echo $a['points_type']; ?>-user-balance-wrap" class="wc-block-components-totals-item" style="display: none;">
        ...
        <span class="wc-block-components-totals-item__value gamipress-wc-points-gateway-user-balance"><?php echo $user_points; ?></span>
    </div>
    ...
    <div id="block-payment-method-gamipress-<?php echo $a['points_type']; ?>-required-balance-wrap" class="wc-block-components-totals-item" style="display: none;">
        ...
        <span class="wc-block-components-totals-item__value gamipress-wc-points-gateway-required-balance"><?php echo $cart_points; ?></span>
    </div>
    ...
    <div id="block-payment-method-gamipress-<?php echo $a['points_type']; ?>-new-balance-wrap" class="wc-block-components-totals-item" style="display: none;">
        ...
        <?php if ( $new_points_balance < 0 ) : ?>
            <span class="wc-block-components-totals-item__value gamipress-wc-points-gateway-new-balance-negative" style="color: red"><?php echo $new_points_balance; ?></span>
        <?php else : ?>
            <span class="wc-block-components-totals-item__value gamipress-wc-points-gateway-new-balance"><?php echo $new_points_balance; ?></span>
        <?php endif; ?>
    </div>
