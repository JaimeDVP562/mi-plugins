 ...
 * 
 * @package AutomatorWP\Mailmint\mailmint-Integration
 * @author  AutomatorWP
 * @since 0.1.0
 */
...
class AutomatorWP_MailMint_Integration {
    ...
    /**
     * Constructor Mailmint Integration
     * 
     * @since   0.1.0
     * @access  public
     * @return  void
    ...
    /**
     * Trigger events ( before form submit )
     * 
     * @since 0.1.0
     * @access public
     * @return void
