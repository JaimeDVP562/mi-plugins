...
/**
 * Get actions response tags for Grok.
 * * Used in the 'tags' parameter of automatorwp_register_action.
 * * @return array
 */
function automatorwp_grok_get_actions_response_tags()
{
    return array(
        'response' => array(
            'label' => __('Grok Response', 'automatorwp-grok'),
            'type'  => 'text',
        ),
    );
}
...
/**
 * Handle the replacement of Grok action tags.
 ...
 * * @return string
 */
function automatorwp_grok_get_action_response_tag_replacement($replacement, $tag_name, $action, $user_id, $action_args, $log)
{
...
add_filter('automatorwp_get_action_tag_replacement', 'automatorwp_grok_get_action_response_tag_replacement', 10, 6);
