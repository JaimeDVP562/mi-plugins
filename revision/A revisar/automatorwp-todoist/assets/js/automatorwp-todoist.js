(function( $ ) {
    ...
    var prefix = 'automatorwp-todoist-';
    var _prefix = 'automatorwp_todoist_';
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        if( consumer_key.length === 0 ) {
            ...
            response_wrap.html( 'All fields are required to connect with Todoist' );
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_todoist_authorize',
                nonce: automatorwp_todoist.nonce,
