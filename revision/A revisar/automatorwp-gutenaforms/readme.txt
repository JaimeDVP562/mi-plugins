=== AutomatorWP - WP Gutena Forms ===
Contributors: automatorwp, rubengc, eneribs
Tags: gutena, form, forms, automatorwp, submission
...
Connect AutomatorWP with WP Gutena Forms

== Description ==

[WP Gutena Forms](https://wordpress.org/plugins/gutena-forms/ "WP Gutena Forms") is a free form-builder plugin that allows you to easily build advanced forms for your WordPress-powered website. Create standard forms, order forms and more with WP Fluent Forms.
...
* **Bug Fixes**
* Fixed deprecated hooks to adapt to Gutena Forms latest version.
