 ...
 *
 * @package     AutomatorWP\Integrations\GutenaForms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_GutenaForms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'gutenaforms';
    public $trigger = 'gutenaforms_anonymous_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-gutenaforms' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-gutenaforms' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-gutenaforms' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-gutenaforms' ), '{post}' ),
...
new AutomatorWP_GutenaForms_Anonymous_Submit_Form();