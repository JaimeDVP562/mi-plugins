 ...
 * Submit Field Value
 *
 * @package     AutomatorWP\Integrations\GutenaForms\Triggers\Submit_Field_Value
...
class AutomatorWP_GutenaForms_Submit_Field_Value extends AutomatorWP_Integration_Trigger {

    public $integration = 'gutenaforms';
    public $trigger = 'gutenaforms_submit_field_value';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User submits a specific field value on a form', 'automatorwp-gutenaforms' ),
            'select_option'     => __( 'User submits <strong>a specific field value</strong> on a form', 'automatorwp-gutenaforms' ),
            /* translators: %1$s: Field name. %2$s: Field value. %3$s: Post title. %4$s: Number of times. */
            'edit_label'        => sprintf( __( 'User submits the %1$s field with the value %2$s on %3$s %4$s time(s)', 'automatorwp-gutenaforms' ), '{field_name}', '{field_value}', '{post}', '{times}' ),
            /* translators: %1$s: Field name. %2$s: Field value. %3$s: Post title. */
            'log_label'         => sprintf( __( 'User submits the %1$s field with the value %2$s on %3$s', 'automatorwp-gutenaforms' ), '{field_name}', '{field_value}', '{post}' ),
            ...
            'options'           => array(
                ...
                'field_value' => array(
                    'from' => 'field_value',
                    'default' => __( 'field value', 'automatorwp-gutenaforms' ), //automatorwp
                    'fields' => array(
                        'field_value' => array(
                            'name' => __( 'Field value:', 'automatorwp-gutenaforms' ), //automatorwp
                            'type' => 'text',
                            'default' => ''
                        )
                    )
     ...
     * @param \GutenaForms\App\Modules\Form\Form $form
     */
...
new AutomatorWP_GutenaForms_Submit_Field_Value();