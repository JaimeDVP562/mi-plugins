...
<?php do_action( 'gamipress_sc_points_gateway_checkout_before', $a ); ?>
    ...
    <tr id="payment-method-gamipress-<?php echo $a['points_type']; ?>-user-balance-wrap" class="gamipress-sc-points-gateway-wrap" style="display: none;">
        <th><?php echo esc_html( $user_points_label ); ?></th>
        <td class="gamipress-sc-points-gateway-user-balance"><?php echo $user_points; ?></td>
    </tr>

    <tr id="payment-method-gamipress-<?php echo $a['points_type']; ?>-required-balance-wrap" class="gamipress-sc-points-gateway-wrap" style="display: none;">
        <th><?php echo esc_html( $cart_points_label ); ?></th>
        <td class="gamipress-sc-points-gateway-required-balance"><?php echo $cart_points; ?></td>
    </tr>

    <tr id="payment-method-gamipress-<?php echo $a['points_type']; ?>-new-balance-wrap" class="gamipress-sc-points-gateway-wrap" style="display: none;">
        <th><?php echo esc_html( $new_points_balance_label ); ?></th>
        <?php if ( $new_points_balance < 0 ) : ?>
            <td class="gamipress-sc-points-gateway-new-balance-negative" style="color: red"><?php echo $new_points_balance; ?></td>
        <?php else : ?>
            <td class="gamipress-sc-points-gateway-new-balance"><?php echo $new_points_balance; ?></td>
        <?php endif; ?>
    </tr>
