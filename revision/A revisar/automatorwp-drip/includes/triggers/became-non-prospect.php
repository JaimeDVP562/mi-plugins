<?php
/**
 * Subscriber Became Non-Prospect
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Became_Non_Prospect
...
class AutomatorWP_Drip_Became_Non_Prospect extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_became_non_prospect';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A Drip subscriber becomes a non-prospect', 'automatorwp-drip' ),
            'select_option' => __( 'A Drip subscriber becomes a <strong>non-prospect</strong>', 'automatorwp-drip' ),
            'edit_label'    => sprintf( __( 'A Drip subscriber becomes a non-prospect %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A Drip subscriber becomes a non-prospect', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_became_non_prospect',
...
new AutomatorWP_Drip_Became_Non_Prospect();
