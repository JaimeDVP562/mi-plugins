<?php
/**
 * Subscriber Unsubscribed from Campaign
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Unsubscribed_From_Campaign_Trigger
...
class AutomatorWP_Drip_Unsubscribed_From_Campaign_Trigger extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_unsubscribed_from_campaign_trigger';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A Drip subscriber unsubscribes from a campaign', 'automatorwp-drip' ),
            'select_option' => __( 'A Drip subscriber <strong>unsubscribes from a campaign</strong>', 'automatorwp-drip' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A Drip subscriber unsubscribes from a campaign %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A Drip subscriber unsubscribes from a campaign', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_unsubscribed_from_campaign_trigger',
...
new AutomatorWP_Drip_Unsubscribed_From_Campaign_Trigger();
