 ...
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Applied_Tag
...
class AutomatorWP_Drip_Applied_Tag extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_applied_tag';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'         => __( 'A tag is applied to a Drip subscriber', 'automatorwp-drip' ),
            'select_option' => __( 'A <strong>tag</strong> is applied to a Drip subscriber', 'automatorwp-drip' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A tag is applied to a Drip subscriber %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A tag is applied to a Drip subscriber', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_applied_tag',
            ...
            'tags'          => array_merge(
                array(
                    ...
                    'drip_tag' => array(
                        ...
                        'type'    => 'text',
                        'preview' => __( 'The tag that was applied', 'automatorwp-drip' ),
                    ),
                ),
     ...
     * @param string $tag        The applied tag name
     */
...
new AutomatorWP_Drip_Applied_Tag();
