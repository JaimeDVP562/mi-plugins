<?php
/**
 * Subscriber Subscribed to Email Marketing
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Subscribed_To_Email_Marketing
...
class AutomatorWP_Drip_Subscribed_To_Email_Marketing extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_subscribed_to_email_marketing';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A subscriber opts in to Drip email marketing', 'automatorwp-drip' ),
            'select_option' => __( 'A subscriber opts in to <strong>Drip email marketing</strong>', 'automatorwp-drip' ),
            'edit_label'    => sprintf( __( 'A subscriber opts in to Drip email marketing %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A subscriber opts in to Drip email marketing', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_subscribed_to_email_marketing',
...
new AutomatorWP_Drip_Subscribed_To_Email_Marketing();
