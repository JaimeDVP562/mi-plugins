 ...
 * 
 * @package   AutomatorWP\Integrations\Dailybot\triggers\Invitation_Created
 * @author    AutomatorWP
 * @since     1.0.0
 */
...
class AutomatorWP_Dailybot_Invitation_Created extends AutomatorWP_Integration_Trigger {
    ...
    public function register()
    {
        automatorwp_register_trigger($this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'User invited to dailybot chat', AUTOMATORWP_DAILYBOT_TEXT_DOMAIN ),
            'select_option'     => __('<strong>User</strong> invited to dailybot chat',AUTOMATORWP_DAILYBOT_TEXT_DOMAIN),
            'edit_label'        => __('User invited to dailybot chat',AUTOMATORWP_DAILYBOT_TEXT_DOMAIN),
            'log_label'         => __('User has invided to dailybot chat'),
