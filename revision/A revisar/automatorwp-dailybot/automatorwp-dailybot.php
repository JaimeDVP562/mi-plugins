 ...
 */
 ...
 final class AutomatorWP_Integration_Dailybot {
     ...
     * @access      public
     * @since       1.0.0
     * @return      AutomatorWP_Integration_Dailybot self::$instance The one true AutomatorWP_Integration_Dailybot
     */
    ...
    private function constants(){
        ...
        // API TimeOut
        define('AUTOMATORWP_DAILYBOT_TIMEOUT', 15 );
   ...
   public function admin_notices(){
        if ( ! $this->meets_requirements() ) { ?>
            <div id="message" class="notice notice-error is-dismissible">
                <p>
                    <?php _e('AutomatorWP - Dailybot needs to function ',AUTOMATORWP_DAILYBOT_TEXT_DOMAIN);?><a href="https://automatorwp.com/">AutomatorWP</a> <?php echo '.'; ?>
                </p>
            </div>
        <?php };
   }
 ...
 /**
   * The main function responsible for returning the one true AutomatorWP_Integration_Dailybot instance to functions everywhere
   *  
   * @since     1.0.0
   * @return    \AutomatorWP_Integration_Daylibot The one true AutomatorWP_Integration_Dailybot
   */
