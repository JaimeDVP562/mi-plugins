...
class AutomatorWP_Monday_Change_Item_Name extends AutomatorWP_Integration_Action {

    public $integration = 'monday';
    public $action = 'monday_change_item_name';
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Change item name', 'automatorwp-monday'),
            'select_option'     => __( 'Change a board\'s item name', 'automatorwp-monday'),
            /* translators: %1$s: Card. */
            'edit_label'        => sprintf( __( 'Change the name of the board (%1$s)\'s item (%2$s)', 'automatorwp-monday' ), '{board}', '{item}' ),
            /* translators: %1$s: Card. */
            'log_label'         => sprintf( __( 'Change the name of the board (%1$s)\'s item (%2$s)', 'automatorwp-monday' ), '{board}', '{item}' ),
            'options'           => array(
                'board' => array(
                    'from' => 'board',
                ...
                'item' => array(
                    ...
                    'fields' => array(
                        ...
                        'new_name' => array(
                            'name' => __('New item name:', 'automatorwp-monday'),
                            'type' => 'text',
                            'default' => '',
                            'required' => true
                        ),
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $response = automatorwp_monday_change_item_name( $board_id, $item_id, $new_name );
        if( $response === 200 ) {
...
new AutomatorWP_Monday_Change_Item_Name();