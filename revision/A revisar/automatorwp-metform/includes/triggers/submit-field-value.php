 ...
 * Submit Field Value
 *
 * @package     AutomatorWP\Integrations\MetForm\Triggers\Submit_Field_Value
...
class AutomatorWP_MetForm_Submit_Field_Value extends AutomatorWP_Integration_Trigger {

    public $integration = 'metform';
    public $trigger = 'metform_submit_field_value';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User submits a specific field value on a form', 'automatorwp-metform' ),
            'select_option'     => __( 'User submits <strong>a specific field value</strong> on a form', 'automatorwp-metform' ),
            /* translators: %1$s: Field name. %2$s: Field value. %3$s: Post title. %4$s: Number of times. */
            'edit_label'        => sprintf( __( 'User submits the %1$s field with the value %2$s on %3$s %4$s time(s)', 'automatorwp-metform' ), '{field_name}', '{field_value}', '{post}', '{times}' ),
            /* translators: %1$s: Field name. %2$s: Field value. %3$s: Post title. */
            'log_label'         => sprintf( __( 'User submits the %1$s field with the value %2$s on %3$s', 'automatorwp-metform' ), '{field_name}', '{field_value}', '{post}' ),
    ...
    public function listener( $form_id, $form_data, $form_settings, $attributes ) {
        ...
        $form_id = isset($form_id['id']) ? $form_data['id'] : $form_id;
...
new AutomatorWP_MetForm_Submit_Field_Value();