(function( $ ) {
    ...
    var prefix = 'automatorwp-iContact-';
    var _prefix = 'automatorwp_iContact_';
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        if( consumer_key.length === 0 || access_token.length === 0 ) {
            ...
            response_wrap.html( 'All fields are required to connect with IContact' );
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_iContact_authorize',
                nonce: automatorwp_iContact.nonce,
    ...
    // On change board
    $('body').on('change', '.automatorwp-action-iContact-create-card .cmb2-id-board select, '
    + '.automatorwp-action-iContact-change-card-list .cmb2-id-board select, '
    + '.automatorwp-action-iContact-delete-card .cmb2-id-board select, '
    + '.automatorwp-action-iContact-change-desc .cmb2-id-board select, '
    + '.automatorwp-action-iContact-comment-card .cmb2-id-board select, '
    + '.automatorwp-action-iContact-add-label .cmb2-id-board select, '
    + '.automatorwp-action-iContact-add-member .cmb2-id-board select, '
    + '.automatorwp-action-iContact-add-checklist-item .cmb2-id-board select', function(e, first_change) {
    ...
    $('body').on('change', '.automatorwp-action-iContact-change-card-list .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-iContact-add-label .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-iContact-add-member .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-iContact-add-checklist-item .cmb2-id-card select', function(e, first_change) {
    ...
    // On change list
    $('body').on('change', '.automatorwp-action-iContact-change-card-list .cmb2-id-list select, '
    + '.automatorwp-action-iContact-delete-card .cmb2-id-list select, '
    + '.automatorwp-action-iContact-change-desc .cmb2-id-list select, '
    + '.automatorwp-action-iContact-comment-card .cmb2-id-list select, '
    + '.automatorwp-action-iContact-add-label .cmb2-id-list select, '
    + '.automatorwp-action-iContact-add-member .cmb2-id-list select, '
    + '.automatorwp-action-iContact-add-checklist-item .cmb2-id-list select', function(e, first_change) {
    ...
    $('body').on('click', '.automatorwp-automation-item-label > .automatorwp-option', function(e) {
        ...
        var item = $(this).closest('.automatorwp-automation-item[class*="iContact"]');
