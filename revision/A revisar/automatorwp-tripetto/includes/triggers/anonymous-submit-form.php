 ...
 *
 * @package     AutomatorWP\Integrations\Tripetto\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Tripetto_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'tripetto';
    public $trigger = 'tripetto_anonymous_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-tripetto' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-tripetto' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-tripetto' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-tripetto' ), '{post}' ),
...
new AutomatorWP_Tripetto_Anonymous_Submit_Form();