 ...
 * Submit Form
 *
 * @package     AutomatorWP\Integrations\Tripetto\Triggers\Submit_Form
...
class AutomatorWP_Tripetto_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'tripetto';
    public $trigger = 'tripetto_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User submits a form', 'automatorwp-tripetto' ),
            'select_option'     => __( 'User submits <strong>a form</strong>', 'automatorwp-tripetto' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User submits %1$s %2$s time(s)', 'automatorwp-tripetto' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User submits %1$s', 'automatorwp-tripetto' ), '{post}' ),
...
new AutomatorWP_Tripetto_Submit_Form();