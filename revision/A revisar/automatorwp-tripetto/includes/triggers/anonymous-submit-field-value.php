 ...
 *
 * @package     AutomatorWP\Integrations\Tripetto\Triggers\Anonymous_Submit_Field_Value
...
class AutomatorWP_Tripetto_Anonymous_Submit_Field_Value extends AutomatorWP_Integration_Trigger {

    public $integration = 'tripetto';
    public $trigger = 'tripetto_anonymous_submit_field_value';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a specific field value on a form', 'automatorwp-tripetto' ),
            'select_option'     => __( 'Guest submits <strong>a specific field value</strong> on a form', 'automatorwp-tripetto' ),
            /* translators: %1$s: Field name. %2$s: Field value. %3$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits the %1$s field with the value %2$s on %3$s', 'automatorwp-tripetto' ), '{field_name}', '{field_value}', '{post}' ),
            /* translators: %1$s: Field name. %2$s: Field value. %3$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits the %1$s field with the value %2$s on %3$s', 'automatorwp-tripetto' ), '{field_name}', '{field_value}', '{post}' ),
...
new AutomatorWP_Tripetto_Anonymous_Submit_Field_Value();