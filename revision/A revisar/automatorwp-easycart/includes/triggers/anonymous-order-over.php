<?php
/**
 * Anonymous EasyCart – Order Over Trigger
 *
 * @package     AutomatorWP\Integrations\EasyCart\Triggers\Anonymous_Order_Over
 * @since       1.0.0
 */
...
class AutomatorWP_EasyCart_Anonymous_Order_Over extends AutomatorWP_Integration_Trigger {

    public $integration = 'easycart';
    public $trigger     = 'easycart_anonymous_order_over';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'     => true,
            'label'         => __( 'Guest places an EasyCart order', 'automatorwp-easycart' ),
            'select_option' => __( 'Guest places an EasyCart order', 'automatorwp-easycart' ),
            'edit_label'    => sprintf( __( 'Guest places an EasyCart order over %1$s', 'automatorwp-easycart' ), '{amount}' ),
            'log_label'     => sprintf( __( 'Guest places an EasyCart order over %1$s', 'automatorwp-easycart' ), '{amount}' ),
    ...
    public function listener( $order_id, $order_data, $order_items ) {
        ...
        // Get the user ID (logged or guest)
    ...
    /**
     * Check if guest deserves the trigger
     *
     * @since 1.0.0
     *
...
new AutomatorWP_EasyCart_Anonymous_Order_Over();
