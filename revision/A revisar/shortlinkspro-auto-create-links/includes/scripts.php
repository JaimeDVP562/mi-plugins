...
function shortlinkspro_admin_register_scripts() {
    ...
    // Auto-Create Links
    wp_register_script( 'shortlinkspro-auto-create-links-js', SHORTLINKSPRO_URL . 'assets/js/shortlinkspro-auto-create-links.js', array( 'jquery' ), SHORTLINKSPRO_VER, true );
...
function shortlinkspro_admin_enqueue_scripts( $hook ) {
    ...
    // Settings screen - Auto-Create Links
    if( $hook === 'shortlinkspro_page_shortlinkspro_settings' ) {

        // Localize auto-create links script
        wp_localize_script( 'shortlinkspro-auto-create-links-js', 'shortlinkspro_auto_create', array(
            'ajaxurl'               => esc_url( admin_url( 'admin-ajax.php', 'relative' ) ),
            'nonce'                 => shortlinkspro_get_admin_nonce(),
            'processing_text'       => __( 'Processing...', 'shortlinkspro' ),
            'confirm_delete_text'   => __( 'Are you sure you want to delete all auto-created links for this post type? This action cannot be undone.', 'shortlinkspro' ),
            'error_text'            => __( 'An error occurred. Please try again.', 'shortlinkspro' ),
            'created_text'          => __( 'links created successfully!', 'shortlinkspro' ),
            'updated_text'          => __( 'links updated successfully!', 'shortlinkspro' ),
            'deleted_text'          => __( 'links deleted successfully!', 'shortlinkspro' ),
        ) );
