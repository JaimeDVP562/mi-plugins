(function( $ ) {
    ...
    var prefix = 'automatorwp-mailjet-';
    var _prefix = 'automatorwp_mailjet_';
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        var secret_key = $('#' + _prefix + 'secret_key').val();
        ...
        if( secret_key.length === 0 || api_key.length === 0 ) {
            response_wrap.addClass( 'automatorwp-notice-error' );
            response_wrap.html( 'All fields are required to connect with Mailjet' );
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_mailjet_authorize',
                nonce: automatorwp_mailjet.nonce,
                api_key: api_key,
    ...
    // On change board
    $('body').on('change', '.automatorwp-action-mailjet-create-card .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-change-card-list .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-delete-card .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-change-desc .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-comment-card .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-add-label .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-add-member .cmb2-id-board select, '
    + '.automatorwp-action-mailjet-add-checklist-item .cmb2-id-board select', function(e, first_change) {
    ...
    $('body').on('change', '.automatorwp-action-mailjet-change-card-list .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-mailjet-add-label .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-mailjet-add-member .cmb2-id-board select', function(e, first_change) {
        var board = $(this).closest('.cmb-row'); 
    ...
    $('body').on('change', '.automatorwp-action-mailjet-add-checklist-item .cmb2-id-card select', function(e, first_change) {
    ...
    // On change list
    $('body').on('change', '.automatorwp-action-mailjet-change-card-list .cmb2-id-list select, '
    + '.automatorwp-action-mailjet-delete-card .cmb2-id-list select, '
    + '.automatorwp-action-mailjet-change-desc .cmb2-id-list select, '
    + '.automatorwp-action-mailjet-comment-card .cmb2-id-list select, '
    + '.automatorwp-action-mailjet-add-label .cmb2-id-list select, '
    + '.automatorwp-action-mailjet-add-member .cmb2-id-list select, '
    + '.automatorwp-action-mailjet-add-checklist-item .cmb2-id-list select', function(e, first_change) {
    ...
    $('body').on('click', '.automatorwp-automation-item-label > .automatorwp-option', function(e) {
        ...
        var item = $(this).closest('.automatorwp-automation-item[class*="mailjet"]');
