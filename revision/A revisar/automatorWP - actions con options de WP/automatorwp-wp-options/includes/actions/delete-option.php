...
class AutomatorWP_WP_Options_Delete_Option extends AutomatorWP_Integration_Action
{
    ...
    public function register()
    {
        automatorwp_register_action($this->action, array(
            ...
            'edit_label'    => sprintf(__('Delete option %1$s', 'automatorwp-wp-options'), '{option_name}'),
            'log_label'     => sprintf(__('Deleted option %1$s', 'automatorwp-wp-options'), '{option_name}'),
            'options'       => array(
                'option_name' => array(
                    'from' => 'option_name',
                    'fields' => array(
...
new AutomatorWP_WP_Options_Delete_Option();
