 ...
 * Description:           Connect AutomatorWP with Keap.
 * Version:               1.0.0
 * Author:                AutomatorWP
...
final class AutomatorWP_Keap {
	...
	private function constants() {
		// Plugin version
		define( 'AUTOMATORWP_KEAP_VER', '1.0.0' );
	...
	private function includes() {
		...
		if ( $this->meets_requirements() ) {
			...
			require_once AUTOMATORWP_KEAP_DIR . 'includes/actions/add-tag.php';
	...
	function register_integration() {
		...
		automatorwp_register_integration( 'keap', array(
			'label' => 'Keap',
			'icon'  => AUTOMATORWP_KEAP_URL . 'assets/keap.svg',
		) );
...
/**
 * The main function responsible for returning the one true AutomatorWP_Keap instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \AutomatorWP_Keap The one true AutomatorWP_Keap
 */
