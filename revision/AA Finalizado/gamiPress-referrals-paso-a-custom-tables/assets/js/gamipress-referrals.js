(function( $ ) {
    ...
    $('body').on( 'click', '#gamipress-referrals-form-submit-button', function(e) {
        ...
        if( gamipress_referrals_is_valid_url( url ) || url.indexOf('/localhost') !== -1 ) {
            ...
            form.find('#gamipress-referrals-copy-button').show();
    ...
    $('body').on( 'click', '#gamipress-referrals-copy-button', function(e) {

        var form = $(this).closest('.gamipress-referrals-form');
        var url = form.find('#gamipress-referrals-form-referral-url-input').val();
        ...
        $('.gamipress-referrals-copy-successful').show();

        gamipress_referrals_hide_copy_message();
    } );

    function gamipress_referrals_hide_copy_message(){
        setTimeout(function() { $(".gamipress-referrals-copy-successful").fadeOut() }, 2000);
    }
