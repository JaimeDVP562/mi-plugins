...
// Función para manejar la autorización AJAX y que no explote nada

function automatorwp_constant_contact_ajax_authorize() {
    // Compruebo que el nonce sea seguro, seguridad ante todo
    ...
    // Miro si los campos están vacíos, porque si no hay datos no puedo seguir
    ...
    // Si todo está bien, guardo los datos en la base de datos
    ...
    // Aquí monto la URL para que el usuario pueda autorizar en Constant Contact
