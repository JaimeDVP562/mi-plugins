...
final class AutomatorWP_WooCommerce {
    ...
    private function includes() {
        ...
        if( $this->meets_requirements() ) {
            ...
            require_once AUTOMATORWP_WOOCOMMERCE_DIR . 'includes/actions/get-order-details.php';
            // WooCommerce Add Product To Order
            require_once AUTOMATORWP_WOOCOMMERCE_DIR . 'includes/actions/add-product-to-order.php';
            // WooCommerce Change the price of a specific product to a new price
            require_once AUTOMATORWP_WOOCOMMERCE_DIR . 'includes/actions/change-product-price.php';
            // WooCommerce Create an Order with a product
            require_once AUTOMATORWP_WOOCOMMERCE_DIR . 'includes/actions/create-order-product.php';
            // WooCommerce Create an Order with a product with a payment gateway
            require_once AUTOMATORWP_WOOCOMMERCE_DIR . 'includes/actions/create-order-payment.php';
