<?php
/**
 * Cancel Subscription Category
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Cancel_Subscription_Category
...
class AutomatorWP_WooCommerce_Cancel_Subscription_Category extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_cancel_subscription_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User cancels subscription of a category', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User cancels subscription of <strong>a category</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User cancels subscription of %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'User cancels subscription of %1$s', 'automatorwp-woocommerce' ), '{term}' ),
...
new AutomatorWP_WooCommerce_Cancel_Subscription_Category();