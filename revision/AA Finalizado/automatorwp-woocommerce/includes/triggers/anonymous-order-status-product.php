<?php
/**
 * Anonymous Order Status Product
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Order_Status_Porduct
...
class AutomatorWP_WooCommerce_Anonymous_Order_Status_Porduct extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_order_status_product';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest\'s order with a product changes its status', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest\'s order with <strong>a product</strong> changes its <strong>status</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Order status. %3$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest\'s order with %1$s changes its status to %2$s %3$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{status}', '{times}' ),
            /* translators: %1$s: Post title. %2$s: Order status. */
            'log_label'         => sprintf( __( 'Guest\'s order with %1$s changes its status to %2$s', 'automatorwp-woocommerce' ), '{post}', '{status}' ),
...
new AutomatorWP_WooCommerce_Anonymous_Order_Status_Porduct();