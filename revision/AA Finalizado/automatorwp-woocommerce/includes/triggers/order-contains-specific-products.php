 ...
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Order_Contains_Specific_Products
...
class AutomatorWP_WooCommerce_Order_Contains_Specific_Products extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_order_contains_specific_products';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes an order containing specific products', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User completes an order containing specific <strong>products</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User completes an order containing specific %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{products}', '{times}' ),
            'log_label'         => __( 'User completes an order containing specific products', 'automatorwp-woocommerce' ),
    ...
    public function user_deserves_trigger( $deserves_trigger, $trigger, $user_id, $event, $trigger_options, $automation ) {
        ...
        // Check if order contains the required products
...
new AutomatorWP_WooCommerce_Order_Contains_Specific_Products();