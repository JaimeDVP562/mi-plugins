<?php
/**
 * Anonymous Purchase Payment Method
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Purchase_Payment_Method
...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Payment_Method extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_purchase_payment_method';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest completes a purchase with a payment method', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest completes a purchase with a <strong>payment method</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Payment Method. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest completes a purchase with %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{payment_method}', '{times}' ),
            /* translators: %1$s: Payment Method. */
            'log_label'         => sprintf( __( 'Guest completes a purchase with %1$s', 'automatorwp-woocommerce' ), '{payment_method}' ),
...
new AutomatorWP_WooCommerce_Anonymous_Purchase_Payment_Method();