 ...
 * Order Status
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Order_Status
...
class AutomatorWP_WooCommerce_Order_Status extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_order_status';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User\'s order status changes', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User\'s <strong>order status</strong> changes', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Order status. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User\'s order status changes to %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{status}', '{times}' ),
            /* translators: %1$s: Order status. */
            'log_label'         => sprintf( __( 'User\'s order status changes to %1$s', 'automatorwp-woocommerce' ), '{status}' ),
...
new AutomatorWP_WooCommerce_Order_Status();