<?php
/**
 * Order Status Product Tag
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Order_Status_Product_Tag
...
class AutomatorWP_WooCommerce_Order_Status_Product_Tag extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_order_status_product_tag';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User\'s order with a product of a tag changes its status', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User\'s order with a product of <strong>a tag</strong> changes its <strong>status</strong>', 'automatorwp-woocommerce' ),
...
new AutomatorWP_WooCommerce_Order_Status_Product_Tag();