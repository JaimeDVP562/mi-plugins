 ...
 * Cancel Subscription
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Cancel_Subscription
...
class AutomatorWP_WooCommerce_Cancel_Subscription extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_cancel_subscription';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User cancels subscription of a product', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User <strong>cancels</strong> subscription of a product', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User cancels subscription of %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User cancels subscription of %1$s', 'automatorwp-woocommerce' ), '{post}' ),
    ...
    public function listener( $subscription ) {
        ...
        foreach ( $items as $item ) {
            ...
            for ( $i = 0; $i < $quantity; $i++ ) {
                ...
                // Trigger the product subscription cancellation
...
new AutomatorWP_WooCommerce_Cancel_Subscription();