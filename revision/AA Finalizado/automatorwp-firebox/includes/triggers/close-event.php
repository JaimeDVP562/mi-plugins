 ...
 * Close Popup Trigger
 *
 * @package     AutomatorWP\Integrations\FireBox\Triggers\Close_Event
...
class AutomatorWP_FireBox_Close_Popup extends AutomatorWP_Integration_Trigger
{

    public $integration = 'firebox';
    public $trigger = 'firebox_close_popup';
    ...
    public function register()
    {
        ...
        automatorwp_register_trigger(
            ...
            array(
                ...
                'label'         => __('User closes a popup', 'automatorwp-firebox'),
                'select_option' => __('User closes <strong>a popup</strong>', 'automatorwp-firebox'),
                'edit_label'    => sprintf(__('User closes %1$s %2$s time(s)', 'automatorwp-firebox'), '{post}', '{times}'),
                'log_label'     => sprintf(__('User closes %1$s', 'automatorwp-firebox'), '{post}'),
                'action'        => array(
...
new AutomatorWP_FireBox_Close_Popup();
