<?php
/**
 * Anonymous Form Process Trigger (guest)
 *
 * Fires before a FireBox form submission from a non-logged-in visitor is saved.
 * Hook: firebox/form/process  — params: $box, $values, $form_id
 *
 * @package     AutomatorWP\Integrations\FireBox\Triggers\Anonymous_Form_Process
 * @since       1.0.0
 */
...
class AutomatorWP_FireBox_Anonymous_Form_Process extends AutomatorWP_Integration_Trigger
{

    public $integration = 'firebox';
    public $trigger     = 'firebox_anonymous_form_process';
    ...
    public function register()
    {
        ...
        automatorwp_register_trigger($this->trigger, array(
            ...
            'anonymous'     => true,
            'label'         => __('Guest submits a form (before saved)', 'automatorwp-firebox'),
            'select_option' => __('Guest submits <strong>a form (before saved)</strong>', 'automatorwp-firebox'),
            'edit_label'    => sprintf(__('Guest processes %1$s %2$s time(s)', 'automatorwp-firebox'), '{form}', '{times}'),
            'log_label'     => sprintf(__('Guest processes %1$s', 'automatorwp-firebox'), '{form}'),
...
new AutomatorWP_FireBox_Anonymous_Form_Process();
