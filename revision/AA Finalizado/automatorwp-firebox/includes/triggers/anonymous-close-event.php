<?php
/**
 * Anonymous Close Popup Trigger
 *
 * @package     AutomatorWP\Integrations\FireBox\Triggers\Anonymous_Close_Event
...
class AutomatorWP_FireBox_Anonymous_Close_Popup extends AutomatorWP_Integration_Trigger
{

    public $integration = 'firebox';
    public $trigger = 'firebox_anonymous_close_popup';
    ...
    public function register()
    {
        ...
        automatorwp_register_trigger(
            ...
            array(
                ...
                'anonymous'     => true,
                'label'         => __('Guest closes a popup', 'automatorwp-firebox'),
                'select_option' => __('Guest closes <strong>a popup</strong>', 'automatorwp-firebox'),
                'edit_label'    => sprintf(__('Guest closes %1$s %2$s time(s)', 'automatorwp-firebox'), '{post}', '{times}'),
                'log_label'     => sprintf(__('Guest closes %1$s', 'automatorwp-firebox'), '{post}'),
                'action'        => array(
                    'firebox/box/on_close',
                ),
...
new AutomatorWP_FireBox_Anonymous_Close_Popup();
