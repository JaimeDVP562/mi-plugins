!(function (e) {
  function a(a) {
    0 ===
      a.find(".gamipress-learndash-points-gateway-checkout-details").length &&
      a
    ...
    var c = a
      ...
      .val();
    if (void 0 !== c && c.startsWith("gamipress_")) {
      var t = c.replace("gamipress_", "");
      (e(
        ...
        .hide(),
        a.find(".gamipress-learndash-points-gateway-checkout-details").show(),
        a
          .find(
      ...
      (a.find(".gamipress-learndash-points-gateway-checkout-details").hide(),
        e(
          ".gamipress-learndash-points-gateway-checkout-details .gamipress-learndash-points-gateway-active",
        )
          .removeClass("gamipress-learndash-points-gateway-active")
  ...
  (e("body").on(
    ...
    function () {
      a(e(this).closest(".wp-block-learndash-checkout"));
    },
  ),
