 ...
 *
 * @package     AutomatorWP\Integrations\WooCommerceBookings\Triggers\Guest-Cancelled-Booking
...
class AutomatorWP_WooCommerceBookings_Guest_Cancelled_Booking extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommercebookings';
    public $trigger = 'woocommercebookings_guest_cancelled_booking';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest cancels booking', 'automatorwp-woocommercebookings' ),
            'select_option'     => __( 'Guest cancels <strong>booking</strong>', 'automatorwp-woocommercebookings' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest cancels %1$s %2$s time(s)', 'automatorwp-woocommercebookings' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest cancels %1$s', 'automatorwp-woocommercebookings' ), '{post}' ),
            'action'            => 'woocommerce_booking_cancelled',
