 ...
 * Cancelled Booking
 *
 * @package     AutomatorWP\Integrations\WooCommerceBookings\Triggers\Cancelled-Booking
...
class AutomatorWP_WooCommerceBookings_Cancelled_Booking extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommercebookings';
    public $trigger = 'woocommercebookings_cancelled_booking';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User cancels booking', 'automatorwp-woocommercebookings' ),
            'select_option'     => __( 'User cancels <strong>booking</strong>', 'automatorwp-woocommercebookings' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User cancels %1$s %2$s time(s)', 'automatorwp-woocommercebookings' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User cancels %1$s', 'automatorwp-woocommercebookings' ), '{post}' ),
