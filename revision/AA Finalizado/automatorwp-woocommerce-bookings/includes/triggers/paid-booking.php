 ...
 * Paid Booking
 *
 * @package     AutomatorWP\Integrations\WooCommerceBookings\Triggers\Paid-Booking
...
class AutomatorWP_WooCommerceBookings_Paid_Booking extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommercebookings';
    public $trigger = 'woocommercebookings_paid_booking';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User pays booking', 'automatorwp-woocommercebookings' ),
            'select_option'     => __( 'User pays <strong>booking</strong>', 'automatorwp-woocommercebookings' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User pays %1$s %2$s time(s)', 'automatorwp-woocommercebookings' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User pays %1$s', 'automatorwp-woocommercebookings' ), '{post}' ),
