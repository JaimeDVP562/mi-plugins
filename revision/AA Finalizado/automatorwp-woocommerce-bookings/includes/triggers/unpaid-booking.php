 ...
 * Unpaid Booking
 *
 * @package     AutomatorWP\Integrations\WooCommerceBookings\Triggers\Unpaid-Booking
...
class AutomatorWP_WooCommerceBookings_Unpaid_Booking extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommercebookings';
    public $trigger = 'woocommercebookings_unpaid_booking';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User unpays booking', 'automatorwp-woocommercebookings' ),
            'select_option'     => __( 'User unpays <strong>booking</strong>', 'automatorwp-woocommercebookings' ),
            'edit_label'        => sprintf( __( 'User unpays %1$s %2$s time(s)', 'automatorwp-woocommercebookings' ), '{post}', '{times}' ),
            'log_label'         => sprintf( __( 'User unpays %1$s', 'automatorwp-woocommercebookings' ), '{post}' ),
