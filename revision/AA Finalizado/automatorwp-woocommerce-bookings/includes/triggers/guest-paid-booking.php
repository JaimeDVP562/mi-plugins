 ...
 * Guest Paid Booking
 *
 * @package     AutomatorWP\Integrations\WooCommerceBookings\Triggers\Guest-Paid-Booking
...
class AutomatorWP_WooCommerceBookings_Guest_Paid_Booking extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommercebookings';
    public $trigger = 'woocommercebookings_guest_paid_booking';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest pays booking', 'automatorwp-woocommercebookings' ),
            'select_option'     => __( 'Guest pays <strong>booking</strong>', 'automatorwp-woocommercebookings' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest pays %1$s %2$s time(s)', 'automatorwp-woocommercebookings' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest pays %1$s', 'automatorwp-woocommercebookings' ), '{post}' ),
            'action'            => 'woocommerce_booking_paid',
