=== GamiPress - LearnDash Partial Payments ===
...
Let users partially pay a LearnDash purchase by using points.

== Description ==

LearnDash Partial Payments gives you the ability to enable GamiPress points types for partially pay any purchase.
...
To register points types as a payment gateway (for full payments), you may check our [LearnDash Points Gateway](https://gamipress.com/add-ons/gamipress-wc-points-gateway/) add-on.
