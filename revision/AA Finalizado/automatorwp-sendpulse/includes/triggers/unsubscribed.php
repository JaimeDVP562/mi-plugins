<?php
/**
 * Trigger: SendPulse - Unsubscribed
 *
...
class AutomatorWP_SendPulse_Unsubscribed_Trigger extends AutomatorWP_Integration_Trigger {
    public $integration = 'sendpulse';
    public $trigger     = 'sendpulse_unsubscribed';

    public function register() {
        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A SendPulse subscriber unsubscribes', 'automatorwp-sendpulse' ),
            'select_option' => __( 'A SendPulse subscriber <strong>unsubscribes</strong>', 'automatorwp-sendpulse' ),
            'edit_label'    => sprintf( __( 'A SendPulse subscriber unsubscribes %1$s time(s)', 'automatorwp-sendpulse' ), '{times}' ),
            'log_label'     => __( 'A SendPulse subscriber unsubscribes', 'automatorwp-sendpulse' ),
            'action'        => 'automatorwp_sendpulse_unsubscribe', // EVENTO: unsubscribe
...
new AutomatorWP_SendPulse_Unsubscribed_Trigger();