<?php
/**
 * Trigger: SendPulse - Subscriber Added
 *
...
class AutomatorWP_SendPulse_Subscriber_Added_Trigger extends AutomatorWP_Integration_Trigger {
    public $integration = 'sendpulse';
    public $trigger     = 'sendpulse_subscriber_added';

    public function register() {
        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A SendPulse subscriber is added', 'automatorwp-sendpulse' ),
            'select_option' => __( 'A SendPulse subscriber <strong>is added</strong>', 'automatorwp-sendpulse' ),
            'edit_label'    => sprintf( __( 'A SendPulse subscriber is added %1$s time(s)', 'automatorwp-sendpulse' ), '{times}' ),
            'log_label'     => __( 'A SendPulse subscriber is added', 'automatorwp-sendpulse' ),
            'action'        => 'automatorwp_sendpulse_subscribe',
...
new AutomatorWP_SendPulse_Subscriber_Added_Trigger();