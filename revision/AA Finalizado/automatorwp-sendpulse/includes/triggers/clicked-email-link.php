...
class AutomatorWP_SendPulse_Clicked_Email_Link_Trigger extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'action'        => 'automatorwp_sendpulse_click',
            ...
            'tags'          => array_merge( array(
                ...
                'sendpulse_link'    => array( 'label' => __( 'Clicked Link', 'automatorwp-sendpulse' ), 'type' => 'text' ),
    ...
    public function listener( $data ) {
        ...
        $link  = isset( $data[0]['link'] ) ? esc_url_raw( $data[0]['link'] ) : '';
