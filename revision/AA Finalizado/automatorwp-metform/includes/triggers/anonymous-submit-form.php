...
class AutomatorWP_MetForm_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest submits a form', 'automatorwp-metform' ),
            'select_option'     => __( 'Guest submits <strong>a form</strong>', 'automatorwp-metform' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Guest submits %1$s', 'automatorwp-metform' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest submits %1$s', 'automatorwp-metform' ), '{post}' ),
    ...
    public function listener( $form_id, $form_data, $form_settings, $attributes ) {
        ...
        // CORRECCIÓN: Usamos $fields_to_process en lugar de la variable inexistente $fields
