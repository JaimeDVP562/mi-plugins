<?php
/**
 * Trigger: Easy Appointments - Appointment Confirmed
 *
 * @package     AutomatorWP\Integrations\easyappointments\Triggers\Appointment_Confirmed
 * @author      AutomatorWP
 * @since       1.0.0
 */
...
class AutomatorWP_EasyAppointments_Appointment_Confirmed extends AutomatorWP_Integration_Trigger {

    public $integration = 'easyappointments';
    public $trigger = 'easyappointments_appointment_confirmed';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User confirms an appointment', 'automatorwp-easyappointments' ),
            'select_option'     => __( 'User confirms <strong>an appointment</strong>', 'automatorwp-easyappointments' ),
            'edit_label'        => __( 'User confirms an appointment', 'automatorwp-easyappointments' ),
            'log_label'         => __( 'User confirms an appointment', 'automatorwp-easyappointments' ),
            'action'            => 'ea_appointment_confirmed',
...
new AutomatorWP_EasyAppointments_Appointment_Confirmed();