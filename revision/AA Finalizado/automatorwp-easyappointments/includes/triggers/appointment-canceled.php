<?php
/**
 * Trigger: Easy Appointments - Appointment Canceled
 *
 * @package     AutomatorWP\Integrations\easyappointments\Triggers\Appointment_Canceled
 * @author      AutomatorWP
 * @since       1.0.0
 */
...
class AutomatorWP_EasyAppointments_Appointment_Canceled extends AutomatorWP_Integration_Trigger {

    public $integration = 'easyappointments';
    public $trigger = 'easyappointments_appointment_canceled';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User cancels an appointment', 'automatorwp-easyappointments' ),
            'select_option'     => __( 'User cancels <strong>an appointment</strong>', 'automatorwp-easyappointments' ),
            'edit_label'        => __( 'User cancels an appointment', 'automatorwp-easyappointments' ),
            'log_label'         => __( 'User cancels an appointment', 'automatorwp-easyappointments' ),
            'action'            => 'ea_appointment_canceled',
...
new AutomatorWP_EasyAppointments_Appointment_Canceled();