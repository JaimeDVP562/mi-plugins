...
final class GamiPress_WooCommerce_Points_Gateway {
    ...
    private function constants() {
        // Plugin version
        define( 'GAMIPRESS_WC_POINTS_GATEWAY_VER', '1.2.1' );

        // GamiPress minimum required version
        define( 'GAMIPRESS_WC_POINTS_GATEWAY_GAMIPRESS_MIN_VER', '3.0.0' );
    ...
    private function meets_requirements() {
        return class_exists( 'GamiPress' )
            && version_compare( GAMIPRESS_VER, GAMIPRESS_WC_POINTS_GATEWAY_GAMIPRESS_MIN_VER, '>=' )
