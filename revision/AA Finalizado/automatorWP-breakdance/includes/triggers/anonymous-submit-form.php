 ...
 *
 * @package     AutomatorWP\Integrations\Breakdance\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_Breakdance_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'breakdance';
    public $trigger = 'breakdance_anonymous_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'          => true,
            'label'             => __( 'User submits a form (anonymous)', 'automatorwp' ),
            'select_option'     => __( 'User submits <strong>a form</strong> (anonymous)', 'automatorwp' ),
...
new AutomatorWP_Breakdance_Anonymous_Submit_Form();