...
final class AutomatorWP_Smoove {
    ...
    private function includes() {
        ...
        if( $this->meets_requirements() ) {
            ...
            // Si tienes un archivo scripts.php real, déjalo. Si también era de Trello y no lo usas, puedes borrar esta línea.
            require_once AUTOMATORWP_SMOOVE_DIR . 'includes/scripts.php';

            // Actions - Aquí incluimos las acciones reales de Smoove
            require_once AUTOMATORWP_SMOOVE_DIR . 'includes/actions/create-contacts.php';
            require_once AUTOMATORWP_SMOOVE_DIR . 'includes/actions/Async-Contact-Status.php';
            require_once AUTOMATORWP_SMOOVE_DIR . 'includes/actions/get-landingpage.php';
            require_once AUTOMATORWP_SMOOVE_DIR . 'includes/actions/get-listi.php';
    ...
    function register_integration() {
        ...
        // Corregido de 'smmove' a 'smoove'
        automatorwp_register_integration( 'smoove', array(
                'label' => 'Smoove',
