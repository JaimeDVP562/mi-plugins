 ...
 * Get Lists
 *
 * @package     AutomatorWP\Integrations\Smoove\Actions\Get-Lists
 * @since       1.0.0
 */
...
class AutomatorWP_Smoove_Get_Lists extends AutomatorWP_Integration_Action {

    public $integration = 'smoove';
    public $action = 'smoove_get_lists';
    ...
    public function register() {
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Get lists', 'automatorwp-smoove' ),
            'select_option'     => __( 'Get <strong>lists</strong>', 'automatorwp-smoove' ),
            'edit_label'        => __( 'Retrieve lists from Smoove', 'automatorwp-smoove' ),
            'log_label'         => __( 'Retrieved lists from Smoove', 'automatorwp-smoove' ),
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $response = automatorwp_smoove_get_lists();

        // Check if API call was successful
        if ( ! is_wp_error( $response ) && is_array( $response ) ) {
            $this->result = __( 'Lists retrieved successfully from Smoove', 'automatorwp-smoove' );
        } else {
            $this->result = __( 'Failed to retrieve lists from Smoove', 'automatorwp-smoove' );
        }
    }
...
new AutomatorWP_Smoove_Get_Lists();