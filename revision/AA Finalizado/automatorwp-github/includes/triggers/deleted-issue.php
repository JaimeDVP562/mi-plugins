...
class AutomatorWP_Github_Delete_Issue_Trigger extends AutomatorWP_Integration_Trigger{

    public $integration = 'github';
    public $trigger = 'github-delete-issue';
    ...
    public function register(){
        automatorwp_register_trigger ($this->trigger, 
            array(
                    ...
                    'anonymous'     => true,
                    'label'         => __('An issue is deleted',AUTOMATORWP_GITHUB_TEXT_DOMAIN),
                    'select_option' => __('An issue is deleted',AUTOMATORWP_GITHUB_TEXT_DOMAIN),
                    'edit_label'    => __('An issue is deleted',AUTOMATORWP_GITHUB_TEXT_DOMAIN),
                    'log_label'     => __('An issue was deleted',AUTOMATORWP_GITHUB_TEXT_DOMAIN),
                    'action'        => 'automatorwp_github_deleted_issue',
    ...
    /**
     * Listen Automator_Github_Delete_Issue_Trigger
     * 
     * @since 1.0.0
     */
...
new AutomatorWP_Github_Delete_Issue_Trigger();