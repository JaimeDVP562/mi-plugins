 ...
 * @since 1.0.0
 */
function gamipress_register_rewards_calendar_current_day_shortcode() {
    gamipress_register_shortcode( 'gamipress_rewards_current_day', array(
        'name'              => __( 'Rewards Calendar Current Day', 'gamipress-daily-login-rewards' ),
        'description'       => __( 'Render the current day of the rewards calendar.', 'gamipress-daily-login-rewards' ),
        'output_callback'   => 'gamipress_rewards_calendar_current_day_shortcode',
        'icon'              => 'calendar-alt',
        'fields'            => array(
            'id' => array(
            ...
            'image_size' => array(
                ...
                'desc' 	        => __( 'Size of the reward image.', 'gamipress-daily-login-rewards' ),
                'type' 	        => 'text',
                'attributes' 	=> array(
                    'type' => 'number',
                    'pattern' => '\d*',
...
add_action( 'init', 'gamipress_register_rewards_calendar_current_day_shortcode' );
 ...
 */
function gamipress_rewards_calendar_current_day_shortcode( $atts = array() ) {
    ...
    ob_start();
    gamipress_get_template_part( 'current-day-reward' );
    $output = ob_get_clean();
