<?php
/**
 * Rewards Calendar Current Day Widget
 *
 * @package     GamiPress\Daily_Login_Rewards\Widgets\Widget\Rewards_Calendar_Current_Day
 * @since       1.0.0
 */
// Exit if accessed directly
if( !defined( 'ABSPATH' ) ) exit;

class GamiPress_Rewards_Calendar_Current_Day_Widget extends GamiPress_Widget {
     ...
     * @var string
     */
    protected $shortcode = 'gamipress_rewards_calendar_current_day';

    public function __construct() {

        parent::__construct(
            $this->shortcode . '_widget',
            __( 'GamiPress: Rewards Calendar Current Day', 'gamipress-daily-login-rewards' ),
            __( 'Render a desired rewards calendar current day.', 'gamipress-daily-login-rewards' )
        );
