...
private function includes() {
        ...
        if ( $this->meets_requirements() ) {
            ...
            $trigger_unverified = AUTOMATORWP_BP_VERIFIED_MEMBER_DIR . 'includes/triggers/trigger-bp-unverified-member.php';
            if ( file_exists( $trigger_unverified ) ) require_once $trigger_unverified;
