...
require_once SHORTLINKSPRO_DIR . 'includes/admin/tools/import-from-plugin/shortify-importer.php';
...
function shortlinkspro_import_from_plugin_button( $field_args, $field ) {
    ...
    echo '<div class="cmb-row shortlinkspro-import-from-plugin-row">'
        . '<p>' . $desc . '</p>'
        . '<button id="' . $id . '" type="button" class="button button-primary shortlinkspro-import-from-plugin-button">' . $label . '</button>'
