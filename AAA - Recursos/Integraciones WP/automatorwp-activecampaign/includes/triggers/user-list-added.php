 ...
 * User List Added
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Triggers\User_List_Added
...
class AutomatorWP_ActiveCampaign_User_List_Added extends AutomatorWP_Integration_Trigger {

    public $integration = 'activecampaign';
    public $trigger = 'activecampaign_user_list_added';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User added to list', 'automatorwp-activecampaign' ),
            'select_option'     => __( 'User added to <strong>list</strong>', 'automatorwp-activecampaign' ),
            /* translators: %1$s: List. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User added to %1$s %2$s time(s)', 'automatorwp-activecampaign' ), '{list}', '{times}' ),
            /* translators: %1$s: List. */
            'log_label'         => sprintf( __( 'User added to %1$s', 'automatorwp-activecampaign' ), '{list}' ),
            'action'            => 'automatorwp_activecampaign_user_list_added',
...
new AutomatorWP_ActiveCampaign_User_List_Added();