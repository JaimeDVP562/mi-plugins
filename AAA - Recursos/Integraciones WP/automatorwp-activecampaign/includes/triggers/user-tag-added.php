...
class AutomatorWP_ActiveCampaign_User_Tag_Added extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'Tag added to user', 'automatorwp-activecampaign' ),
            'select_option'     => __( '<strong>Tag</strong> added to user', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Tag. %2$s: Number of times. */
            'edit_label'        => sprintf( __( '%1$s added to user %2$s time(s)', 'automatorwp-activecampaign' ), '{tag}', '{times}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( '%1$s added to user', 'automatorwp-activecampaign' ), '{tag}' ),
