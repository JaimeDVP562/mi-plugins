 ...
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Triggers\Anonymous_Contact_Tag_Added
...
class AutomatorWP_ActiveCampaign_Anonymous_Contact_Tag_Added extends AutomatorWP_Integration_Trigger {

    public $integration = 'activecampaign';
    public $trigger = 'activecampaign_anonymous_contact_tag_added';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Tag added to a contact', 'automatorwp-activecampaign' ),
            'select_option'     => __( '<strong>Tag</strong> added to a Contact', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Tag. %2$s: Number of times. */
            'edit_label'        => sprintf( __( '%1$s added to contact %2$s time(s)', 'automatorwp-activecampaign' ), '{tag}', '{times}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( '%1$s added to contact', 'automatorwp-activecampaign' ), '{tag}' ),
    ...
    public function listener( $params ) {
		...
		$this->result = sprintf( __( '%1$s was added to %2$s', 'automatorwp-activecampaign' ), $tag, $email );
...
new AutomatorWP_ActiveCampaign_Anonymous_Contact_Tag_Added();