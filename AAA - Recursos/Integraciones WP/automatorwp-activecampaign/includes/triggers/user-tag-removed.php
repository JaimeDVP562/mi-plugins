 ...
 * User Tag Removed
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Triggers\User_Tag_Removed
...
class AutomatorWP_ActiveCampaign_User_Tag_Removed extends AutomatorWP_Integration_Trigger {

    public $integration = 'activecampaign';
    public $trigger = 'activecampaign_user_tag_removed';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'Tag removed from user', 'automatorwp-activecampaign' ),
            'select_option'     => __( '<strong>Tag</strong> removed from user', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Tag. %2$s: Number of times. */
            'edit_label'        => sprintf( __( '%1$s removed from user %2$s time(s)', 'automatorwp-activecampaign' ), '{tag}', '{times}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( '%1$s removed from user', 'automatorwp-activecampaign' ), '{tag}' ),
            'action'            => 'automatorwp_activecampaign_user_tag_removed',
    ...
    public function log_fields( $log_fields, $log, $object ) {
        ...
        $log_fields['tag'] = array(
            'name' => __( 'Tag removed:', 'automatorwp-activecampaign' ),
            'type' => 'text',
        );
...
new AutomatorWP_ActiveCampaign_User_Tag_Removed();