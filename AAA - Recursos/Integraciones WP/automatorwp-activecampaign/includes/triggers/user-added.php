...
class AutomatorWP_ActiveCampaign_User_Added extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User added to ActiveCampaign', 'automatorwp-activecampaign' ),
            'select_option'     => __( '<strong>User</strong> added to ActiveCampaign', 'automatorwp-activecampaign' ),
            'edit_label'        => __( 'User added to ActiveCampaign', 'automatorwp-activecampaign' ),
            'log_label'         => __( 'User added to ActiveCampaign', 'automatorwp-activecampaign' ),
    ...
    public function listener( $params, $user_id ) {
		...
		$this->result = sprintf( __( '%1$s was added to ActiveCampaign', 'automatorwp-activecampaign' ), $email );
