<?php
/**
 * Anonymous Contact Unsubscribed
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Triggers\Anonymous_Contact_Unsubscribed
...
class AutomatorWP_ActiveCampaign_Anonymous_Contact_Unsubscribed extends AutomatorWP_Integration_Trigger {

    public $integration = 'activecampaign';
    public $trigger = 'activecampaign_anonymous_contact_unsubscribed';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Contact unsubscribed from ActiveCampaign', 'automatorwp-activecampaign' ),
            'select_option'     => __( '<strong>Contact</strong> unsubscribed from ActiveCampaign', 'automatorwp-activecampaign' ),
            'edit_label'        => __( 'Contact unsubscribed from ActiveCampaign', 'automatorwp-activecampaign' ),
            'log_label'         => __( 'Contact unsubscribed from ActiveCampaign', 'automatorwp-activecampaign' ),
            'action'            => 'automatorwp_activecampaign_contact_unsubscribed',
    ...
    public function listener( $params ) {
		...
		$this->result = sprintf( __( '%1$s contact was unsubscribed from ActiveCampaign', 'automatorwp-activecampaign' ), $email );
		
        // Trigger the contact is unsubscribed 
...
new AutomatorWP_ActiveCampaign_Anonymous_Contact_Unsubscribed();