 ...
 * Add contact
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Actions\Add_Contact
...
class AutomatorWP_ActiveCampaign_Add_Contact extends AutomatorWP_Integration_Action {

    public $integration = 'activecampaign';
    public $action = 'activecampaign_add_contact';
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add contact to ActiveCampaign', 'automatorwp-activecampaign' ),
            'select_option'     => __( 'Add <strong>contact</strong> to ActiveCampaign', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Contact. */
            'edit_label'        => sprintf( __( 'Add %1$s to ActiveCampaign', 'automatorwp-activecampaign' ), '{contact}' ),
            /* translators: %1$s: Contact. */
            'log_label'         => sprintf( __( 'Add %1$s to ActiveCampaign', 'automatorwp-activecampaign' ), '{contact}' ),
            'options'           => array(
                'contact' => array(
                    'from' => 'email',
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        if ( ! empty( $response['contacts'] ) ) {
            ...
            $this->result = sprintf( __( 'Contact %s added to ActiveCampaign.', 'automatorwp-activecampaign' ), $contact_data['email'] );
...
new AutomatorWP_ActiveCampaign_Add_Contact();