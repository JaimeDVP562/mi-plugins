...
class AutomatorWP_ActiveCampaign_Add_User_Tag extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add tag to user', 'automatorwp-activecampaign' ),
            'select_option'     => __( 'Add <strong>tag</strong> to <strong>user</strong>', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Tag. */
            'edit_label'        => sprintf( __( 'Add %1$s to user', 'automatorwp-activecampaign' ), '{tag}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( 'Add %1$s to user', 'automatorwp-activecampaign' ), '{tag}' ),
            'options'           => array(
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $this->result = sprintf( __( 'Tag added to %s', 'automatorwp-activecampaign' ), $user->user_email );
    }
