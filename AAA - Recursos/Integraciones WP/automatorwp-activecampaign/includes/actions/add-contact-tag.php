 ...
 * Add tag to contact
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Actions\Add_Contact_Tag
...
class AutomatorWP_ActiveCampaign_Add_Contact_Tag extends AutomatorWP_Integration_Action {

    public $integration = 'activecampaign';
    public $action = 'activecampaign_add_contact_tag';
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add tag to contact', 'automatorwp-activecampaign' ),
            'select_option'     => __( 'Add <strong>tag</strong> to <strong>contact</strong>', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Tag. %2$s: Contact. */
            'edit_label'        => sprintf( __( 'Add %1$s to %2$s', 'automatorwp-activecampaign' ), '{tag}', '{contact}' ),
            /* translators: %1$s: Tag. %2$s: Contact. */
            'log_label'         => sprintf( __( 'Add %1$s to %2$s', 'automatorwp-activecampaign' ), '{tag}', '{contact}' ),
            'options'           => array(
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $this->result = sprintf( __( 'Tag added to %s', 'automatorwp-activecampaign' ), $contact_data['user_email'] );
    }
...
new AutomatorWP_ActiveCampaign_Add_Contact_Tag();