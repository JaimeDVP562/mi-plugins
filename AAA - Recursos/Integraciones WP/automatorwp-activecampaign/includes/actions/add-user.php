...
class AutomatorWP_ActiveCampaign_Add_User extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add user to ActiveCampaign', 'automatorwp-activecampaign' ),
            'select_option'     => __( 'Add <strong>user</strong> to ActiveCampaign', 'automatorwp-activecampaign' ),
            'edit_label'        => __( 'Add user to ActiveCampaign', 'automatorwp-activecampaign' ),
            'log_label'         => __( 'Add user to ActiveCampaign', 'automatorwp-activecampaign' ),
            'options'           => array(
                // No options
            ),
        ) );
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        if ( ! empty( $response['contacts'] ) ) {
            ...
            $this->result = sprintf( __( '%s is already a contact in ActiveCampaign', 'automatorwp-activecampaign' ), $user->user_email );
            return;
        ...
        $this->result = sprintf( __( '%s added to ActiveCampaign', 'automatorwp-activecampaign' ), $user->user_email );
