 ...
 *
 * @package     AutomatorWP\Integrations\ActiveCampaign\Actions\Update_Contact_Fields
...
class AutomatorWP_ActiveCampaign_Update_Contact_Fields extends AutomatorWP_Integration_Action {

    public $integration = 'activecampaign';
    public $action = 'activecampaign_update_contact_fields';
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Update contact custom field with a value', 'automatorwp-activecampaign' ),
            'select_option'     => __( 'Update <strong>contact</strong> custom field with a value', 'automatorwp-activecampaign' ),
            /* translators: %1$s: Contact. %2$s: Custom Field. %3$s: Custom Value. */
            'edit_label'        => sprintf( __( 'Update %1$s custom field %2$s with %3$s ', 'automatorwp-activecampaign' ), '{contact}', '{ACfield}', '{value}' ),
            /* translators: %1$s: Contact. %2$s: Custom Field. */
            'log_label'         => sprintf( __( 'Update %1$s custom field %2$s', 'automatorwp-activecampaign' ), '{contact}', '{ACfield}' ),
            'options'           => array(
                'contact' => array(
                    'from' => 'user_email',
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $response_fields = automatorwp_activecampaign_update_custom_field( $ACfield_id, $contact_id, $ACfield_value);

        if ( $response_fields['response']['code'] === 200 ) {
...
new AutomatorWP_ActiveCampaign_Update_Contact_Fields();