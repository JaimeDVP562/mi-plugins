...
button.prop('disabled',!1)})});$('body').on('click','.automatorwp-activecampaign-view-webhook',function(e){e.preventDefault();$(this).parent().next().slideDown('fast')})})(jQuery)