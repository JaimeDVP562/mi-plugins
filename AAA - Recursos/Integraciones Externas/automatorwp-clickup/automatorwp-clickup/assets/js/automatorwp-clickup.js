(function( $ ) {
    ...
    var prefix = 'automatorwp-senpulse-';
    var _prefix = 'automatorwp_senpulse_';
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        if( token.length === 0 ) {
            ...
            response_wrap.html( 'API token is required to connect with senpulse' );
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_senpulse_authorize',
                nonce: automatorwp_senpulse.nonce,
                token: token,
            },
            function( response ) {
    ...
    // On change team
    $('body').on('change', '.automatorwp-action-senpulse-create-list .cmb2-id-team select, '
        + '.automatorwp-action-senpulse-add-comment-task .cmb2-id-team select, '
        + '.automatorwp-action-senpulse-add-tag-task .cmb2-id-team select, '
        + '.automatorwp-action-senpulse-create-task .cmb2-id-team select, '
        + '.automatorwp-action-senpulse-remove-task .cmb2-id-team select, '
        + '.automatorwp-action-senpulse-remove-tag-task .cmb2-id-team select', function(e, first_change) {
    ...
    // On change space
    $('body').on('change', '.automatorwp-action-senpulse-create-list .cmb2-id-space select, '
        + '.automatorwp-action-senpulse-add-comment-task .cmb2-id-space select, '
        + '.automatorwp-action-senpulse-add-tag-task .cmb2-id-space select, '
        + '.automatorwp-action-senpulse-create-task .cmb2-id-space select, '
        + '.automatorwp-action-senpulse-remove-task .cmb2-id-space select, '
        + '.automatorwp-action-senpulse-remove-tag-task .cmb2-id-space select', function(e, first_change) {
        ...
        // On change folder
    $('body').on('change', '.automatorwp-action-senpulse-create-list .cmb2-id-folder select, '
        + '.automatorwp-action-senpulse-add-comment-task .cmb2-id-folder select, '
        + '.automatorwp-action-senpulse-add-tag-task .cmb2-id-folder select, '
        + '.automatorwp-action-senpulse-create-task .cmb2-id-folder select, '
        + '.automatorwp-action-senpulse-remove-task .cmb2-id-folder select, '
        + '.automatorwp-action-senpulse-remove-tag-task .cmb2-id-folder select', function(e, first_change) {
    ...
    // On change list
    $('body').on('change', '.automatorwp-action-senpulse-add-comment-task .cmb2-id-list select, '
        + '.automatorwp-action-senpulse-add-tag-task .cmb2-id-list select, '
        + '.automatorwp-action-senpulse-remove-task .cmb2-id-list select, '
        + '.automatorwp-action-senpulse-remove-tag-task .cmb2-id-list select', function(e, first_change) {
	...
	// On change task
    $('body').on('change', '.automatorwp-action-senpulse-add-comment-task .cmb2-id-task select, '
        + '.automatorwp-action-senpulse-add-tag-task .cmb2-id-task select, '
        + '.automatorwp-action-senpulse-remove-task .cmb2-id-task select, '
        + '.automatorwp-action-senpulse-remove-tag-task .cmb2-id-task select', function(e, first_change) {
    ...
    var item = $(this).closest('.automatorwp-automation-item[class*="senpulse"]');
