 ...
 *
 * @package     AutomatorWP\Integrations\Bento\Actions\Remove_Tag_From_Subscriber
...
class AutomatorWP_Bento_Remove_Tag_From_Subscriber extends AutomatorWP_Integration_Action {

    public $integration = 'bento';
    public $action = 'bento_remove_tag_from_subscriber';
    ...
    public function execute( $action, $user_id, $action_options, $automation ) {
        ...
        $response = automatorwp_bento_remove_tag_subscriber( $user->user_email, $tag_id );
...
new AutomatorWP_Bento_Remove_Tag_From_Subscriber();