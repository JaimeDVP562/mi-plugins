 ...
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Marked_As_Undeliverable
...
class AutomatorWP_Drip_Marked_As_Undeliverable extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_marked_as_undeliverable';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A Drip subscriber is marked as undeliverable', 'automatorwp-drip' ),
            'select_option' => __( 'A Drip subscriber is marked as <strong>undeliverable</strong>', 'automatorwp-drip' ),
            'edit_label'    => sprintf( __( 'A Drip subscriber is marked as undeliverable %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A Drip subscriber is marked as undeliverable', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_marked_as_undeliverable',
...
new AutomatorWP_Drip_Marked_As_Undeliverable();
