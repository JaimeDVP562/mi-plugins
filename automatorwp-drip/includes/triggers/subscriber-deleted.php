 ...
 * Subscriber Deleted
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Subscriber_Deleted
...
class AutomatorWP_Drip_Subscriber_Deleted extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_subscriber_deleted';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A subscriber is deleted in Drip', 'automatorwp-drip' ),
            'select_option' => __( 'A <strong>subscriber</strong> is deleted in Drip', 'automatorwp-drip' ),
            'edit_label'    => sprintf( __( 'A subscriber is deleted in Drip %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A subscriber is deleted in Drip', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_subscriber_deleted',
            'function'      => array( $this, 'listener' ),
            'priority'      => 10,
            'accepted_args' => 1,
            'options'       => array( 'times' => automatorwp_utilities_times_option() ),
            'tags'          => array_merge( array(
                'drip_subscriber_email' => array( 'label' => __( 'Subscriber Email', 'automatorwp-drip' ), 'type' => 'text', 'preview' => __( 'The email of the deleted subscriber', 'automatorwp-drip' ) ),
...
new AutomatorWP_Drip_Subscriber_Deleted();
