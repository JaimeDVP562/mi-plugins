 ...
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Completed_Campaign
...
class AutomatorWP_Drip_Completed_Campaign extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_completed_campaign';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'         => __( 'A subscriber completes a Drip campaign', 'automatorwp-drip' ),
            'select_option' => __( 'A subscriber completes a <strong>Drip campaign</strong>', 'automatorwp-drip' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A subscriber completes a Drip campaign %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A subscriber completes a Drip campaign', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_completed_campaign',
            ...
            'tags'          => array_merge(
                array(
                    ...
                    'drip_campaign_id' => array(
                        ...
                        'type'    => 'text',
                        'preview' => __( 'The ID of the completed Drip campaign', 'automatorwp-drip' ),
                    ),
                ),
...
new AutomatorWP_Drip_Completed_Campaign();
