<?php
/**
 * Subscriber Updated Alias
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Updated_Alias
...
class AutomatorWP_Drip_Updated_Alias extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_updated_alias';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A Drip subscriber updates their email alias', 'automatorwp-drip' ),
            'select_option' => __( 'A Drip subscriber updates their <strong>email alias</strong>', 'automatorwp-drip' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A Drip subscriber updates their email alias %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A Drip subscriber updates their email alias', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_updated_alias',
            ...
            'tags'          => array_merge( array(
                ...
                'drip_new_email'        => array( 'label' => __( 'New Email', 'automatorwp-drip' ), 'type' => 'text', 'preview' => __( 'The new alias email address', 'automatorwp-drip' ) ),
...
new AutomatorWP_Drip_Updated_Alias();
