 ...
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Complained
...
class AutomatorWP_Drip_Complained extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_complained';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A Drip subscriber marks an email as spam', 'automatorwp-drip' ),
            'select_option' => __( 'A Drip subscriber marks an email as <strong>spam</strong>', 'automatorwp-drip' ),
            'edit_label'    => sprintf( __( 'A Drip subscriber marks an email as spam %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A Drip subscriber marks an email as spam', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_complained',
...
new AutomatorWP_Drip_Complained();
