 ...
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Marked_As_Deliverable
...
class AutomatorWP_Drip_Marked_As_Deliverable extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_marked_as_deliverable';

    public function register() {

        automatorwp_register_trigger( $this->trigger, array(
            'integration'   => $this->integration,
            'label'         => __( 'A Drip subscriber is marked as deliverable', 'automatorwp-drip' ),
            'select_option' => __( 'A Drip subscriber is marked as <strong>deliverable</strong>', 'automatorwp-drip' ),
            'edit_label'    => sprintf( __( 'A Drip subscriber is marked as deliverable %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A Drip subscriber is marked as deliverable', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_marked_as_deliverable',
...
new AutomatorWP_Drip_Marked_As_Deliverable();
