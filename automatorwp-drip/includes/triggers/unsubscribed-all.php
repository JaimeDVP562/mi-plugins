<?php
/**
 * Subscriber Unsubscribed From All
 *
 * @package     AutomatorWP\Integrations\Drip\Triggers\Unsubscribed_All
...
class AutomatorWP_Drip_Unsubscribed_All extends AutomatorWP_Integration_Trigger {

    public $integration = 'drip';
    public $trigger     = 'drip_unsubscribed_all';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'         => __( 'A subscriber unsubscribes from all Drip email marketing', 'automatorwp-drip' ),
            'select_option' => __( 'A subscriber unsubscribes from all <strong>Drip email marketing</strong>', 'automatorwp-drip' ),
            /* translators: %1$s: Number of times. */
            'edit_label'    => sprintf( __( 'A subscriber unsubscribes from all Drip email marketing %1$s time(s)', 'automatorwp-drip' ), '{times}' ),
            'log_label'     => __( 'A subscriber unsubscribes from all Drip email marketing', 'automatorwp-drip' ),
            'action'        => 'automatorwp_drip_unsubscribed_all',
            ...
            'tags'          => array_merge(
                array(
                    'drip_subscriber_email' => array(
                        ...
                        'type'    => 'text',
                        'preview' => __( 'The email of the unsubscribed Drip subscriber', 'automatorwp-drip' ),
                    ),
                ),
...
new AutomatorWP_Drip_Unsubscribed_All();
