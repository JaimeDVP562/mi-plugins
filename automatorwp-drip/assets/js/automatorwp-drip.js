(function( $ ) {
    ...
    var prefix = 'automatorwp-drip-';
    var _prefix = 'automatorwp_drip_';
    ...
    $('body').on('click', '.automatorwp_settings #' + _prefix + 'authorize', function(e) {
        ...
        if( key.length === 0 || secret.length === 0 ) {
            ...
            response_wrap.html( 'All fields are required to connect with Drip' );
        ...
        $.post(
            ajaxurl,
            {
                action: 'automatorwp_drip_authorize',
                nonce: automatorwp_drip.nonce,
                key: key,
                secret: secret,
            },
            function( response ) {
